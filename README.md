...
Once the `conda-forge` channel has been enabled, `pytest-bdd` can be installed with:

```
conda install pytest-bdd
```

It is possible to list all of the versions of `pytest-bdd` available on your platform with:
